...
{
    //Initialize all configuration and setup from within here
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, SeedData seedData )
        {
            ...
            seedData.Seed();//initialize database with data
            app.UseCors(b => b.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader());//allow cross domain access
